...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    ...
    <div style="margin-top: 40px" class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            ...
            <div style="margin-top: 10%" class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> {{ __('Lembrar de mim') }}
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg">{{ __('Logar') }}</button>
          </div>
        </div>
      </form>
      <div class="row">
