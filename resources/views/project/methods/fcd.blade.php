                    ...
                    <div class="card card-login card-hidden mb-3">
                            ...
                            @for ($i = 1; $i <= Request::input('period'); $i++) <div class="bmd-form-group mt-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="data[]" class="form-control"
                                        placeholder="{{ __('Informe o valor do período ') }}{{$i}}" value="" required>
                                </div>
                                @endfor
                        </div>
                        @else
                        <div class="card-body ">
                            <div class="bmd-form-group mt-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="tax" class="form-control"
                                        placeholder="{{ __('Informe a taxa...') }}" value="" required>
                                </div>
                                <div class="bmd-form-group mt-3">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="number" name="period" class="form-control"
                                            placeholder="{{ __('Informe a quantidade de período (meses/anos)...') }}"
                                            value="" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer justify-content-center">
                                <button type="submit"
                                    class="btn btn-primary btn-link btn-lg">{{ __('Próximo') }}</button>
                            </div>
                        </div>
                        <input type="hidden" name="data[]" class="form-control"
                            placeholder="{{ __('Informe o valor do período ') }}" value="" required>
                        <input type="hidden" name="calculated" class="form-control"
                            placeholder="{{ __('Responsáveis do projeto...') }}" value="0" hidden>
                        <input type="hidden" class="form-check-input" type="text" name="method"
                            value="{{ $data['method'] }}">
                        <input type="hidden" name="name" class="form-control"
                            placeholder="{{ __('Nome do projeto...') }}" value="{{ $data['name'] }}" hidden>
                        <input type="hidden" name="responsible" class="form-control"
