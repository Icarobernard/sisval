        ...
        <div class="card-body ">
            ...
            <div class="bmd-form-group mt-3">
                <div class="input-group">
                    ...
                    <input type="number" name="maintenance" class="form-control" value="{{ $method->maintenance }}"
                        required>
                </div>
            </div>
            <div class="bmd-form-group mt-3">
            ...
            <div class="bmd-form-group mt-3">
                <div class="input-group">
                    ...
                    <input step="0.01" type="number" name="tax" class="form-control" value="{{ $method->tax }}"
                        required>
                </div>
            </div>
            <div class="bmd-form-group mt-3">
            ...
            <div class="bmd-form-group mt-3">
                <div class="input-group input-group-static mb-4">
                    ...
                    <select title="Nível de Prontidão Tecnológica da Patente (NPT)" name="npt" class="form-control"
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pmargem == 'low' ? "checked" :null}}
                                ...
                                class="form-check-input" type="radio" name="contribution" id="inlineRadio1" value="low">
                            Baixo
                            <span class="circle">
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pmargem == 'medium' ? "checked" :null}}
                                ...
                                class="form-check-input" type="radio" name="contribution" id="inlineRadio2"
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pmargem == 'high' ? "checked" :null}}
                                title="Pmargem: Alto prêmio no critério margem de contribuição" class="form-check-input"
                                type="radio" name="contribution" id="inlineRadio1" value="high">Alto
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                        </label>
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pvolume == 'low' ? "checked" :null}}
                                title="Pvolume: Baixo prêmio no critério volume" class="form-check-input" type="radio"
                                name="volume" id="inlineRadio1" value="low"> Baixo
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                        </label>
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pvolume == 'medium' ? "checked" :null}}
                                title="Pvolume: Moderado prêmio no critério volume" class="form-check-input"
                                type="radio" name="volume" id="inlineRadio2" value="medium"> Moderado
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                        </label>
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pvolume == 'high' ? "checked" :null}}
                                title="Pvolume: Alto prêmio no critério volume" class="form-check-input" type="radio"
                                name="volume" id="inlineRadio1" value="high">Alto
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                        </label>
            ...
            <div class="bmd-form-group mt-3">
                <div class="input-group">
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pinvestimento == 'low' ? "checked" :null}} class="form-check-input"
                                type="radio" name="investment" id="inlineRadio1" value="low"> Baixo
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                        </label>
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pinvestimento == 'medium' ? "checked" :null}} class="form-check-input"
                                type="radio" name="investment" id="inlineRadio2" value="medium"> Moderado
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                        </label>
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                        <label class="form-check-label">
                            <input {{$method->pinvestimento == 'high' ? "checked" :null}} class="form-check-input"
                                type="radio" name="investment" id="inlineRadio1" value="high">Alto
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                        </label>
